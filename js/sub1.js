...
let infoTabBtn = document.querySelectorAll('.info-tab-btn');
let introductionItems = document.querySelectorAll('.introduction-items');

infoTabBtn.forEach(function(btn){
    btn.addEventListener('click', function(){
        infoTabBtn.forEach(function(b){
            b.classList.remove('on');
        })
        this.classList.add('on')
        introductionItems.forEach(function(item){
